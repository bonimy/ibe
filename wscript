...
def build(bld):
    ...
    bld.symlink_as(data_dir + 'spitzer/deepdrill_images/images',
    ...
    bld.symlink_as(data_dir + 'bolocam/bolocam_images_v2/images',
                   '/irsadata/BOLOCAM_GPS/images')
    ...
    bld.symlink_as(data_dir + 'cosmos/cosmos_ultravista/images',
                   '/irsadata/COSMOS/images')
    bld.symlink_as(data_dir + 'cosmos/a3cosmos_images/images',
                   '/irsadata/COSMOS/images')
